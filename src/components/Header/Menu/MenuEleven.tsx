...
const MenuEleven = () => {
  ...
  return (
    <>
      <div
        className={`${fixedHeader ? " fixed" : "relative"} header-menu bg-white w-full top-0 z-10 duration-500`}
      >
        <div
          className={`header-menu style-eigh bg-white w-full md:h-[74px] h-[56px]`}
        >
